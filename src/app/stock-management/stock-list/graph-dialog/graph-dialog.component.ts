...
//       type: 'line',
//       data: {
//         labels: this.data.history.map((entry: any) => entry.date),
//         datasets: [{
//           label: 'Stock-In History Quantity',
//           data: this.data.history.map((entry: any) => entry.quantity),
//           borderColor: 'rgb(75, 192, 192)',
//           tension: 0.1
//         }, {
//           label: 'Stock-Dispatch History Quantity',
//           data: this.data.outgoingHistory.map((entry: any) => entry.quantity),
